...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        #Go through letters of alphabet
        #For all non-vowels, map to itself
        #For vowels, map to corresponding value in vowels_permutation
        
        for char in VOWELS_LOWER:
            encryption_dic[char] = vowels_permutation[vowel_counter].lower()
            encryption_dic[VOWELS_UPPER[vowel_counter]] = vowels_permutation[vowel_counter].upper()
            vowel_counter = vowel_counter+1
        for char in CONSONANTS_LOWER:
            encryption_dic[char] = char
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for char in self.get_message_text():
            if char not in " !@#$%^&*()-_+={}[]|\:;'<>?,./\"":
                encrypted_word=encrypted_word+transpose_dict[char]
            else:
...
if __name__ == '__main__':
    ...
    # Example test case
    message = SubMessage("Somebody, once told me!!!")
    permutation = "eaiuo"
