...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        return encryption_dict #maps letters to shifted letters
    ...
    def apply_shift(self, shift):
        ...
        for char in self.get_message_text():
            if char not in " !@#$%^&*()-_+={}[]|\:;'<>?,./\"":
                encrypted_word=encrypted_word+encryption_dict[char]
            else:
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        #For shift from 1 to 26
        max_num_words=0
        best_decryption=""
        best_shift=0
        for shift in range(26):
            num_words=0
            #Apply shift to the message
            shifted_message=self.apply_shift(shift)
            #Count number of valid words in shifted message
            ...
            if num_words>max_num_words:
                ...
                best_decryption=shifted_message
                
        #return tuple of shift and message
